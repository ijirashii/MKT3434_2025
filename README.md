# 🧠 Neural Network Design & Training GUI - MKT3434 Homework-3 📚

Welcome to the advanced neural network GUI system for interactive model design, training, and evaluation. Developed as part of the Machine Learning/Deep Learning course, this project aims to provide a full visual pipeline for building, training, and analyzing deep learning models — all with no coding required!

---

## ✨ What's New in This Assignment?

### 1. 🏗️ Interactive Neural Network Designer
- Design model architectures layer-by-layer from the GUI.
- Dynamically **add**, **remove**, or **reorder** layers.
- Supported layers:
  - ✅ Dense (with ReLU, Sigmoid, Tanh)
  - ✅ Conv2D and MaxPooling2D
  - ✅ LSTM and GRU for sequence modeling
  - ✅ Dropout, Flatten, and GlobalAveragePooling2D

📸 Screenshots:  
![Layer Configuration1](screenshots/interface1.png)
![Layer Configuration2](screenshots/add_layer1.png)
![Layer Configuration3](screenshots/add_layer2.png)
![Layer Configuration4](screenshots/add_layer3.png)
![Layer Configuration5](screenshots/add_layer4.png)
![Layer Configuration6](screenshots/add_layer5.png)
![Layer Configuration7](screenshots/add_layer6.png)
![Layer Configuration8](screenshots/add_layer_summary1.png)

---

### 2. 🧠 Pre-trained Model Fine-Tuning
- Load and fine-tune popular pre-trained models:
  - VGG16
  - ResNet50
  - MobileNetV2
  - EfficientNetB0
- Optionally freeze base layers.
- Append your own custom classification head.
- Data preprocessing and resizing handled internally.

📸 Screenshot:  
![Pretrained Fine-tuning1](screenshots/pretrained1.png)
![Pretrained Fine-tuning2](screenshots/pretrained2.png)

---

### 3. 🏋️ Advanced Training Control
- Choose from three optimizers:
  - Adam
  - SGD
  - RMSprop
...
- Add regularization:
  - Dropout layers
  - L2 Regularization (via Keras parameters)
- Use early stopping based on validation loss.

📸 Screenshot:  
![Training Config](screenshots/train_model2.png)

---

### 4. 📊 Live Training Visualization
- Real-time updates per epoch:
  - Epoch progress
  - Metric logs (accuracy, loss)
- Plot loss and accuracy vs. epoch curves using Matplotlib.
- Visual logs displayed in a text box and plots.

📸 Screenshot:  
Adam:
![Training Visualization1](screenshots/result1.png)
SGD:
![Training Visualization3](screenshots/sgd.png)
RMSprop:
![Training Visualization5](screenshots/rmsprop.png)
...
- Automatic test set evaluation after training:
  ...
  - Loss
- Save/load models as `.h5` (Keras) or `.json` (architecture only).

📸 Screenshot:  
Adam:
![Final Metrics2](screenshots/result11.png)
SGD:
![Final Metrics4](screenshots/sgd1.png)
RMSprop:
![Final Metrics6](screenshots/rmsprop1.png)

---

### 6. 🌱 Image Augmentation Panel
- Built-in augmentations for image datasets (like MNIST):
  - Rotation
  - Horizontal & Vertical Flip
  - Zoom Scaling

📸 Screenshot:  
![Augmentation Options](screenshots/agumetation.png)
